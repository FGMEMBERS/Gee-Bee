...
var battery = Battery.new(12,30,12,1.0,12.0); 					# Définition des caractéristiques de la batterie
var alternator = Alternator.new("/engines/engine/rpm",250.0,12.0,40.0);		# Définition des caractéristiques de l'alternateur
...
var update_virtual_bus = func(dt) {
    ...
    if (bus_volts > 1.0){						# Si la tension du Bus est supérieur à 1V
        if (power_source == "battery"){					# Si la source est la batterie
            ...
            bus_amps = battery.charge_amps;				# Sinon l'intensité du Bus est l'intensité fourni par l'alternateur (limité par les caractéristique la batterie)
        }
    }
...
############################################################################
#################### Mesure des charges du bus électrique ##################
############################################################################
